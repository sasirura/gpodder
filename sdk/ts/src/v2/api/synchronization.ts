...
import type { DeviceSyncStatus, UpdateDeviceSyncParams } from "../types/synchronization.js"
...
export async function updateDeviceSync(params: UpdateDeviceSyncParams): Promise<DeviceSyncStatus> {
    const username = getUsername()
    const config = await getClientConfig()
    ...
    const body = {
        ...
        ...(params.stopSynchronize ? { "stop-synchronize": params.stopSynchronize } : {})
    }
